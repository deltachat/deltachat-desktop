...
import { NormalMessageAttachmentSubset } from '../../../shared/shared-types'
...
export function hasAttachment(attachment: NormalMessageAttachmentSubset | null) {
...
export function dragAttachmentOut(
  file: NormalMessageAttachmentSubset['file'],
