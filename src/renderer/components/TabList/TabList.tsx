...
export default function TabList({ tabNames, tabChangeCb, children }: PropsWithChildren<TabListProps>) {
  const [currentTab, setCurrentTab] = useState<number>(0)
  useEffect(() => tabChangeCb(tabNames[currentTab]), [currentTab])
...
function TabListHeader({ currentTab, onChangeTab, tabs, children }: PropsWithChildren<TabListHeaderProps>) {
  return (
