...
export const Message = React.memo(props => {
  ...
  return (
    <div className='chat-list-item__message'>
      ...
      {summary.status && <div className={classNames('chat-list-item__message__status-icon', summary.status)} />}
  ...
  >
    ...
    <div className='chat-list-item__content'>
      ...
      <div className='chat-list-item__message'>
        ...
        <div className={classNames('chat-list-item__message__status-icon', 'delivered')} />
      </div>
    </div>
  </div>
})
