...
export class Electron implements Runtime {
  ...
  notifyWebxdcStatusUpdate(accountId: number, instanceId: number): void {
    ipcBackend.invoke('notifyWebxdcStatusUpdate', accountId, instanceId)
  }
  notifyWebxdcMessageChanged(accountId: number, instanceId: number): void {
    ipcBackend.invoke('notifyWebxdcMessageChanged', accountId, instanceId)
  }
  notifyWebxdcInstanceDeleted(accountId: number, instanceId: number): void {
    ipcBackend.invoke('notifyWebxdcInstanceDeleted', accountId, instanceId)
  }
  saveBackgroundImage(
    file: string,
