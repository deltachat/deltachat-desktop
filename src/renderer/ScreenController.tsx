...
import { ScreenProvider, Screens } from './contexts/ScreenContext'
...
function Screen() {
  ...
  switch (screen) {
    case Screens.Main:
      // Key attribute here is a hack to force a clean rerendering when the
      // account changes
      return <MainScreen key={String(accountId)} />
    case Screens.Login:
