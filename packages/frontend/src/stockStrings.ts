...
export async function updateCoreStrings() {
  ...
  type StockStringsSomeOmited = Omit<
    ...
    | typeof C.DC_STR_CHANNEL_LEFT_BY_YOU
    | typeof C.DC_STR_CANCELED_CALL
    | typeof C.DC_STR_DECLINED_CALL
    | typeof C.DC_STR_INCOMING_CALL
    | typeof C.DC_STR_MISSED_CALL
    | typeof C.DC_STR_OUTGOING_CALL
