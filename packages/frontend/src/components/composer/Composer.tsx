          ...
          {settingsStore && (
            <>
              ...
              <ComposerMessageInput
                ...
                chatId={chatId}
                chatName={selectedChat.name}
                // We don't store the edits as "drafts" anywhere extept
...
function useMessageEditing(
  ...
  const doSendEditRequest = useCallback(() => {
    ...
    BackendRemote.rpc
      ...
      .catch(err => {
        ...
        // https://github.com/deltachat/deltachat-desktop/issues/4469
      })
  ...
  }, [accountId, editMessageInputRef, originalMessage])
