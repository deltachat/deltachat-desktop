import { R as React, a as Children, i as isValidElement, c as createElement, C as Component } from './common/source.production-86e2832f.js';
import { c as createCommonjsModule, g as getCjsExportFromNamespace, u as unwrapExports, R as ReactIs, P as PropTypes } from './common/index-ed166f27.js';

var allLocaleData = {};

var _nodeResolve_empty = /*#__PURE__*/Object.freeze({
    __proto__: null,
    'default': allLocaleData
});
...
getCjsExportFromNamespace(_nodeResolve_empty);
...
unwrapExports(es5$1);
var es5_1$1 = es5$1.defineProperty;
var es5_2$1 = es5$1.objCreate;
var es5_3 = es5$1.arrIndexOf;
var es5_4 = es5$1.isArray;
var es5_5 = es5$1.dateNow;
...
function RelativeFormat(locales, options) {
    ...
    es5$1.defineProperty(this, '_locale', { value: this._resolveLocale(locales) });
    es5$1.defineProperty(this, '_options', { value: {
            style: this._resolveStyle(options.style),
            units: this._isValidUnits(options.units) && options.units
        } });
    es5$1.defineProperty(this, '_locales', { value: locales });
    es5$1.defineProperty(this, '_fields', { value: this._findFields(this._locale) });
    es5$1.defineProperty(this, '_messages', { value: es5$1.objCreate(null) });
    // "Bind" `format()` method to `this` so it can be passed by reference like
    // the other `Intl` APIs.
...
// Define internal private properties for dealing with locale data.
es5$1.defineProperty(RelativeFormat, '__localeData__', { value: es5$1.objCreate(null) });
es5$1.defineProperty(RelativeFormat, '__addLocaleData', { value: function () {
  ...
  var InjectIntl = function (_Component) {
    ...
    createClass(InjectIntl, [{
      ...
      value: function getWrappedInstance() {
        browser(withRef, '[React Intl] To access the wrapped instance, ' + 'the `{withRef: true}` option must be set when calling: ' + '`injectIntl()`');
      ...
      value: function render() {
        ...
        return React.createElement(WrappedComponent, _extends({}, this.props, defineProperty$1({}, intlPropName, this.context.intl), {
...
function formatMessage(config, state) {
  ...
  {
    browser(!isValidElement(config), '[React Intl] Don\'t pass React elements to ' + 'formatMessage(), pass `.props`.');
  }
...
export { FormattedDate, FormattedHTMLMessage, FormattedMessage, FormattedNumber, FormattedPlural, FormattedRelative, FormattedTime, IntlProvider, addLocaleData, defineMessages, injectIntl, intlShape };
