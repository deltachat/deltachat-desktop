...
Sometimes you want to package the app for macOS for testing, but don't have the required certificates for signing it, in that case you can set the following environment variable to skip code signing:
