...
The configuration for eslint is documented here: [`https://eslint.org/docs/configuration-files`](https://eslint.org/docs/latest/use/configure/configuration-files)
