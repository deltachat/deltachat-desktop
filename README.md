...
| [`Electron`](https://www.electronjs.org/) :electron:                                               | Browser 🦊🧭🏐                                                                                                                                                                                |
| -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <img src="README_ASSETS/desktop.png" style="max-width:256px;min-hight:200px" />                    | <img src="README_ASSETS/browser-screenshot.png" style="max-width:256px;min-hight:200px" />                                                                                                    |
